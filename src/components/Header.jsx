...
// NOTE: Logo colors updated for Saudi National Day theme (Aug 27, 2025)
// Original colors backed up in LOGO_COLORS_BACKUP.js
// Original: Red #ee2e3a, Blue #243e87
// Current: Dark Green #1a3d1a, Medium Green #2d5a2d
...
const Header = () => {
  ...
  return (
    <header
      className="w-full bg-white/90 dark:bg-gray-900/80 backdrop-blur-lg shadow-lg border-b border-gray-200/50 dark:border-[#FFD700]/20 px-4 lg:px-8 py-4 transition-all duration-300"
      ...
      <div className="container mx-auto max-w-5xl flex flex-col sm:flex-row items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-4">
          ...
          <button
            ...
            className="group flex items-center gap-2 px-3 py-2 bg-white/30 dark:bg-gray-900/30 backdrop-blur-sm rounded-lg border border-white/40 dark:border-[#FFD700]/30 hover:border-[#006C35]/50 dark:hover:border-[#FFD700]/50 shadow-sm hover:shadow-md transition-all duration-300"
            aria-label={
          ...
          >
            ...
            {/* Language Text */}
            <span
              className={`text-sm font-medium text-[#1a3d1a] dark:text-[#F4E4BC] group-hover:text-[#006C35] dark:group-hover:text-[#FFD700] transition-colors duration-300 ${
                i18n.language === "ar" ? "font-elegant-ar" : "font-elegant-en"
              }`}
            >
            ...
            {/* Simple Arrow */}
            <svg
              className="w-3 h-3 text-[#1a3d1a] dark:text-[#F4E4BC] group-hover:text-[#006C35] dark:group-hover:text-[#FFD700] transition-all duration-300 group-hover:rotate-180"
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
            >
