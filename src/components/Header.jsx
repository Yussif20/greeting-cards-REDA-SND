...
const Header = () => {
  ...
  return (
    <header
      className="w-full bg-white/80 dark:bg-gray-900/80 backdrop-blur-lg shadow-lg border-b border-white/20 dark:border-[#FFD700]/20 px-4 lg:px-8 py-4 transition-all duration-300"
    ...
    >
      <div className="container mx-auto max-w-5xl flex flex-col sm:flex-row items-center justify-between gap-4">
        ...
        <a
          ...
          className="flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-[#006C35] to-[#004225] text-white font-medium rounded-lg shadow-lg hover:shadow-xl hover:-translate-y-0.5 transition-all duration-300 border border-[#006C35]/20"
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="relative lang-switcher-glow">
            <button
              className="group relative flex items-center gap-2 px-4 py-2 bg-white/20 dark:bg-gray-900/30 backdrop-blur-lg rounded-xl border border-white/30 dark:border-[#FFD700]/20 hover:border-[#006C35]/40 dark:hover:border-[#FFD700]/40 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-0.5"
            ...
            >
              ...
              <div className="absolute inset-0 bg-gradient-to-br from-white/10 to-transparent dark:from-[#006C35]/5 dark:to-transparent rounded-xl transition-all duration-300 group-hover:from-[#006C35]/10 dark:group-hover:from-[#FFD700]/10"></div>

              <div className="relative z-10 flex items-center gap-2">
                {/* Language Flag/Icon */}
                <div className="w-5 h-5 rounded-full overflow-hidden border border-[#006C35]/30 dark:border-[#FFD700]/30 pulse-saudi">
                  {i18n.language === "ar" ? (
                    // US Flag for English
                ...
                {/* Language Text */}
                <span className="text-sm font-semibold text-[#004225] dark:text-[#F4E4BC] group-hover:text-[#006C35] dark:group-hover:text-[#FFD700] transition-colors duration-300">
                  {i18n.language === "ar" ? "English" : "العربية"}
                </span>

                {/* Animated Arrow */}
                <svg
                  className="w-4 h-4 text-[#006C35] dark:text-[#FFD700] transition-transform duration-300 group-hover:rotate-180"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
